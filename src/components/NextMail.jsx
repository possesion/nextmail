...
const NextMail = () => {
  ...
  const [listElements, ] = useState(['LinkedIn']);
  ...
  const [messages, ] = useState([
    ...
    { id: 5, title: 'Day', contact: 'TechCrunch', time: 'Yesterday', attachment: '' },
    { id: 6, title: 'Kevin', contact: 'Goodreads', time: 'Yesterday', attachment: '' },
    { id: 7, title: '2016', contact: 'randomGuy', time: '09 Oct, 16', attachment: '' },
    { id: 8, title: 'Goldfinger', contact: 'Bond', time: 'Oct, 1964', attachment: '' }

  ]);
  const [profile, ] = useState({ name: 'Salman  Shah', img: 'profileImg', mail: 'shah.salman4@gmail.com' });
  return (
